          ...
          {REVIEWS.map((review) => (
            <div
              ...
              className={`p-10 shadow-sm rounded-sm flex flex-col relative ${
                review.featured ? 'bg-esti-dark text-white' : 'bg-white'
              }`}
            >
              <Quote size={28} className={`mb-6 flex-shrink-0 ${review.featured ? 'text-esti-gold' : 'text-esti-beige'}`} />
              ...
              <p
                className={`font-sans font-light mb-8 italic leading-relaxed flex-grow ${
              ...
              <div className="mt-auto">
                <p className={`font-serif text-lg ${review.featured ? 'text-white' : 'text-esti-dark'}`}>{review.author}</p>
                <p
