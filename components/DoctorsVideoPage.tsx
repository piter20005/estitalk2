              ...
              {isUnlocked ? (
                ...
                <div className="bg-zinc-900 text-white rounded-sm p-8 shadow-xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h2 className="font-serif text-2xl mb-1">Kup dostęp do odcinka</h2>
                    ...
                    <p className="text-center text-xs text-gray-500">Płatność bezpieczna przez Stripe.</p>
                    <div className="mt-6 pt-6 border-t border-white/10 space-y-2">
                      {['Natychmiastowy dostęp po zakupie', 'Wiedza kliniczna bez uproszczeń', 'Prawie godzina rozmowy z ekspertem'].map((item) => (
