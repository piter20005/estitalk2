        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="w-full lg:w-7/12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="font-sans text-xs font-bold tracking-[0.2em] uppercase text-esti-gold">O prowadzącej</span>
            </div>
            ...
            <div className="space-y-6 text-lg font-light leading-relaxed text-esti-taupe font-sans">
              <p>
                Lekarz z powołania, specjalistka dermatologii i wenerologii, a także ekspertka w dziedzinie medycyny
                estetycznej. Dla Dr Tatiany Jasińskiej medycyna to nie tylko nauka, ale przede wszystkim sztuka dbania
                o zdrowie, harmonię i pewność siebie swoich pacjentów.
              </p>
              <p>
                Z ogromną pasją łączy najnowszą, popartą badaniami wiedzę medyczną z holistycznym podejściem do piękna.
                W swojej praktyce stawia na naturalność i bezpieczeństwo, wierząc głęboko, że świadoma pielęgnacja to
                fundament długowieczności skóry.
              </p>
            </div>
            ...
            <div className="mt-10 p-8 bg-white border-l-2 border-esti-gold shadow-sm relative">
              ...
              <p className="font-serif text-xl italic text-esti-dark leading-relaxed relative z-10">
                &ldquo;Prawdziwe piękno zaczyna się od zdrowej skóry i akceptacji siebie. Moją misją jest pomóc Ci odkryć
                to piękno na nowo, opierając się na faktach medycznych, a nie mitach.&rdquo;
              </p>
            </div>
